 ...
 */
 ...
 /*
    |--------------------------------------------------------------------------
    | Baris Bahasa Fungsi dan Kelas
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut ini digunakan untuk berbagai fungsi dan kelas pada aplikasi
    | selain itu digunakan untuk informasi yang ditampilkan pada user. Anda bebas memodifikasi
