            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('no_pendaftaran')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('nama_siswa')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('tempat_lahir')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('tanggal_lahir')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('agama')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('alamat')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('kel_desa')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('kecamatan')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('asal_sekolah')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('nama_ayah')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row multiSelect">
                        ...
                        <div class="col-md-10" style="position: relative">
                            <select class="form-select" id="pekerjaan_ayah" name="pekerjaan_ayah" required="true" data-placeholder="{{trans('dokre.select')}}" style="width: 100%" data-width="100%" data-allow-clear="true">
                            ...
                            <div class="invalid-feedback @if ($errors->has('pekerjaan_ayah')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('nama_ibu')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row multiSelect">
                        ...
                        <div class="col-md-10" style="position: relative">
                            <select class="form-select" id="pekerjaan_ibu" name="pekerjaan_ibu" required="true" data-placeholder="{{trans('dokre.select')}}" style="width: 100%" data-width="100%" data-allow-clear="true">

                                @foreach($pekerjaan_orang_tua_all as $id => $value)
                                    <option value="{{ $id }}" {{ (old('pekerjaan_ibu') ? old('pekerjaan_ibu') : $data->pekerjaan_ibu ?? '') == $id ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback @if ($errors->has('pekerjaan_ibu')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('nomor_telp')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('kelas')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('tahun_ajaran')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            @if (isset($data->foto_pendaftar) && Storage::disk(config("dokre_config.filesystem"))->exists($dokre_data['fileInfo']["foto_pendaftar"]['original']["folder"].$data->foto_pendaftar))
                            <a href="{{ Storage::disk(config("dokre_config.filesystem"))->url($dokre_data['fileInfo']["foto_pendaftar"]['original']["folder"].$data->foto_pendaftar) }}" target="_blank" class="tableImage">
                                    <img src="{{ Storage::disk(config("dokre_config.filesystem"))->url($dokre_data['fileInfo']["foto_pendaftar"]['original']["folder"].$data->foto_pendaftar) }}">
                                </a><br>
                                <div class="form-check form-checkbox">
                                <input class="form-check-input" type="checkbox" name="foto_pendaftar_dokre_delete" id="foto_pendaftar_dokre_delete" value="1">
                                <label class="form-check-label" for="foto_pendaftar_dokre_delete"> {{trans('dokre.remove_file')}}</label>
                            </div>
                            @endif
                            <input type="file" class="imageUpload mt-1" id="foto_pendaftar" accept=".jpg,.png,.jpeg" data-type=".jpg,.png,.jpeg"  name="foto_pendaftar"  data-selected="{{trans('dokre.selected_image_preview')}}" >
                            <input type="hidden" id="foto_pendaftar_dokre_current" name="foto_pendaftar_dokre_current" value="{{$data->foto_pendaftar??''}}">
                            <div class="invalid-feedback @if ($errors->has('foto_pendaftar')) d-block @endif" data-required="{{trans('dokre.required_image')}}" data-size="{{trans('dokre.required_size')}}" data-type="{{trans('dokre.required_type')}}">
                                @if ($errors->has('foto_pendaftar')){{ $errors->first('foto_pendaftar') }}@endif
                            </div>
                            <small id="foto_pendaftar_help" class="text-muted">{{trans("dokre.file_extension_limit")}}.jpg,.png,.jpeg. {{trans("dokre.recommended")}}{{trans("dokre.width")}}1024px, {{trans("dokre.height")}}768px. {{trans("dokre.image_action")}}{{trans("dokre.image_action_resize")}}.</small>
                        </div>
                    </div>
                </div>
            </div>
