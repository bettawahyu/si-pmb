...
@endsection
@section('backBtn')
<a href="{{ route("manage.kelas.index") }}"><i class="fas fa-angle-left"></i> {{trans('dokre.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage kelas_manage dokreForm">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('nama_kelas')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('kapasitas')) d-block @endif">{{trans('dokre.required_text')}}</div>
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("manage.kelas.index") }}" class="btn btn-secondary float-end" role="button">{{trans('dokre.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
