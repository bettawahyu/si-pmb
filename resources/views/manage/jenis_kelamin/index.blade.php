...
@endsection
@section('content')
<div class="card jenis_kelamin_index dokreIndex">
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-sm order-3 order-sm-0 pt-2">
                    @if(Gate::any(['jenis_kelamin_allow']))
                        <a href="{{route('manage.jenis_kelamin.create')}}" class="btn btn-primary" role="button"><i class="fas fa-plus fa-fw"></i> {{trans('dokre.table_add')}}</a>
                    @endIf
                </div>
