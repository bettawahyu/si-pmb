...
@endsection
@section('content')
<div class="card tahun_ajaran_index admikoIndex">
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-sm order-3 order-sm-0 pt-2">
                    @if(Gate::any(['tahun_ajaran_allow']))
                        <a href="{{route('manage.tahun_ajaran.create')}}" class="btn btn-primary" role="button"><i class="fas fa-plus fa-fw"></i> {{trans('admiko.table_add')}}</a>
                    @endIf
                </div>
