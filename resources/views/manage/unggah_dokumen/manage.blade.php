...
@endsection
@section('backBtn')
<a href="{{ route("manage.unggah_dokumen.index") }}"><i class="fas fa-angle-left"></i> {{trans('admiko.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage unggah_dokumen_manage admikoForm">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('nama_dokumen')) d-block @endif">{{trans('admiko.required_text')}}</div>
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("manage.unggah_dokumen.index") }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
