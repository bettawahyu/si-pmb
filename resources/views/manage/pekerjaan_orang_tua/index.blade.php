...
@section('breadcrumbs')
<li class="breadcrumb-item active" aria-current="page">Pekerjaan Orang Tua</li>
@endsection
@section('pageTitle')
...
@endsection
@section('content')
<div class="card pekerjaan_orang_tua_index admikoIndex">
    <div class="card-body">
        <div class="tableBox" id="tableBox">
            ...
            <div class="tableLayout pb-2">
                    ...
                    <thead>
                        <tr data-sort-method='thead'>
							<th scope="col" class="text-nowrap">Jenis Pekerjaan</th>
                            <th scope="col" class="w-5 no-sort" data-orderable="false">{{trans("admiko.table_edit")}}</th>
                            @if(Gate::allows('pekerjaan_orang_tua_allow'))
                    ...
                    @foreach($tableData as $data)
                        <tr>
							<td class="text-nowrap">{{$data->jenis_pekerjaan}}</td>
                            <td class="w-5 no-sort"><a href="{{route("manage.pekerjaan_orang_tua.edit",[$data->id])}}"><i class="fas fa-edit fa-fw"></i></a></td>
                            @if(Gate::allows(['pekerjaan_orang_tua_allow']))
            ...
            <div class="row">
                <div class="col-12 col-sm order-3 order-sm-0 pt-2">
                    @if(Gate::any(['pekerjaan_orang_tua_allow']))
                        <a href="{{route('manage.pekerjaan_orang_tua.create')}}" class="btn btn-primary" role="button"><i class="fas fa-plus fa-fw"></i> {{trans('admiko.table_add')}}</a>
                    @endIf
                </div>
    ...
    <div class="modal fade" id="deleteConfirm" tabindex="-1" role="dialog" aria-labelledby="deleteConfirm" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="post" class="w-100" action="{{route("manage.pekerjaan_orang_tua.delete")}}">
            @method('DELETE')
            @csrf
