...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active">{{ trans('dokre.roles_page_title') }}</li>
@endsection
@section('pageTitle')
...
>>>>>>> Stashed changes
                ...
                <div class="tableLayout">
                    <table class="table" data-dom="tr" data-page-length='-1'>
                        ...
                        <tr data-sort-method='thead'>
                            ...
                            <th scope="col" class="">{{ trans('dokre.roles_title') }}</th>
                        ...
                        @foreach($tableData as $data)
                            <tr>
                                ...
                                <td class="w-5 no-sort">
                                    @if($data->id != 1)
                                        <a href="{{route('manage.admin_roles.destroy',$data->id)}}" data-id="{{$data->id}}" class="dokre_deleteConfirm" data-bs-toggle="modal" data-bs-target="#deleteConfirm"><i class="fas fa-trash fa-fw"></i></a>
                                    @endIf
                                </td>
                            </tr>
                        @endforeach
                ...
                <div class="row">
                    <div class="col-12 col-sm order-3 order-sm-0 pt-3">
                        <a href="{{route('manage.admin_roles.create')}}" class="btn btn-primary" role="button"><i class="fas fa-plus fa-fw"></i> {{ trans('dokre.table_add') }}</a>
                    </div>
