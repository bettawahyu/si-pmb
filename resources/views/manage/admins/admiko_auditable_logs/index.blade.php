            ...
            <div class="tableLayout">
                <table class="table tableSort" data-dom="tr" data-paging="false">
                    ...
                    @foreach($tableData as $data)
                        <tr>
							<td class="w-5"><a href="{{route("manage.admiko_auditable_logs.show",[$data->id])}}">{{$data->id}}</a></td>
                            ...
                            <td class="w-5 no-sort"><a href="{{route('manage.admiko_auditable_logs.show',[$data->id])}}"><i class="fas fa-eye fa-fw"></i></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
