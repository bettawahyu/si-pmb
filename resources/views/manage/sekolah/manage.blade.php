...
@endsection
@section('backBtn')
<a href="{{ route("manage.sekolah.index") }}"><i class="fas fa-angle-left"></i> {{trans('dokre.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage sekolah_manage dokreForm">
    <legend class="action"><b>Data Profil Sekolah:</b></legend>
    <form method="POST" action="{{ $dokre_data['formAction'] }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('nama_sekolah')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="invalid-feedback @if ($errors->has('alamat_sekolah')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('kab_kota')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('provinsi')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('akreditasi')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('tahun_akre')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('telp_sekolah')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 col-lg-8">
                            ...
                            <div class="invalid-feedback @if ($errors->has('email_sekolah')) d-block @endif">{{trans('dokre.required_text')}}</div>
                ...
                <div class=" col-lg-6">
                    <div class="form-group row">
                        <label for="website_sekolah" class="col-md-2 col-lg-4 col-form-label">Website Sekolah:*</label>
                        <div class="col-md-10 col-lg-8">
                            <input type="text" class="form-control" id="website_sekolah" name="website_sekolah" required="true" placeholder="Alamat Web Sekolah"  value="{{{ old('website_sekolah', isset($data)?$data->website_sekolah : '') }}}">
                            <div class="invalid-feedback @if ($errors->has('website_sekolah')) d-block @endif">{{trans('dokre.required_text')}}</div>
                            <small id="website_sekolah_help" class="text-muted"></small>
                        </div>
                    </div>
                </div>
                <div class=" col-lg-6">
                    <div class="form-group row">
                        <label for="logo_sekolah" class="col-md-2 col-form-label">Logo Sekolah:</label>
                        <div class="col-md-10">
                            @if (isset($data->logo_sekolah) && Storage::disk(config("dokre_config.filesystem"))->exists($dokre_data['fileInfo']["logo_sekolah"]['original']["folder"].$data->logo_sekolah))
                            <a href="{{ Storage::disk(config("dokre_config.filesystem"))->url($dokre_data['fileInfo']["logo_sekolah"]['original']["folder"].$data->logo_sekolah) }}" target="_blank" class="tableImage">
                                    <img src="{{ Storage::disk(config("dokre_config.filesystem"))->url($dokre_data['fileInfo']["logo_sekolah"]['original']["folder"].$data->logo_sekolah) }}">
                                </a><br>
                                <div class="form-check form-checkbox">
                                <input class="form-check-input" type="checkbox" name="logo_sekolah_dokre_delete" id="logo_sekolah_dokre_delete" value="1">
                                <label class="form-check-label" for="logo_sekolah_dokre_delete"> {{trans('dokre.remove_file')}}</label>
                            </div>
                            @endif
                            <input type="file" class="imageUpload mt-1" id="logo_sekolah" accept=".jpg,.png,.jpeg" data-type=".jpg,.png,.jpeg"  name="logo_sekolah"  data-selected="{{trans('dokre.selected_image_preview')}}" >
                            <input type="hidden" id="logo_sekolah_dokre_current" name="logo_sekolah_dokre_current" value="{{$data->logo_sekolah??''}}">
                            <div class="invalid-feedback @if ($errors->has('logo_sekolah')) d-block @endif" data-required="{{trans('dokre.required_image')}}" data-size="{{trans('dokre.required_size')}}" data-type="{{trans('dokre.required_type')}}">
                                @if ($errors->has('logo_sekolah')){{ $errors->first('logo_sekolah') }}@endif
                            </div>
                            <small id="logo_sekolah_help" class="text-muted">{{trans("dokre.file_extension_limit")}}.jpg,.png,.jpeg. {{trans("dokre.recommended")}}{{trans("dokre.width")}}512px, {{trans("dokre.height")}}512px. {{trans("dokre.image_action")}}{{trans("dokre.image_action_resize")}}.</small>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("manage.sekolah.index") }}" class="btn btn-secondary float-end" role="button">{{trans('dokre.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
