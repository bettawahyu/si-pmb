...
function richTextEditor() {
    if ($(".simple_text_editor").length > 0) {
        tinymce.init({
            ...
            toolbar:
                "bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link | removeformat | undo redo | code fullscreen",
    ...
    if ($(".advanced_text_editor").length > 0) {
        tinymce.init({
            ...
            toolbar:
                "bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | forecolor backcolor | link codesample | fontselect fontsizeselect formatselect | removeformat | undo redo | code fullscreen",
            toolbar_mode: "sliding",
            statusbar: false,
            height: 250,
        });
