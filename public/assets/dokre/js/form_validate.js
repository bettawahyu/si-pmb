...
if ($(".formPage").length > 0) {
    ...
    $(".save-button").on("click", function (event) {
        ...
        $(this).html(
            '<div class="h-100 d-flex align-items-center justify-content-around"><div class="spinner-border spinner-border-sm" role="status"></div></div>'
        );
    });
