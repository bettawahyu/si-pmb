<?php
/** Dokre configuration file for your custom pages**/
 ...
 * If you add global search for your child page in your child model you have to setup array $dokreGlobalSearchParent
 * It is used to create correct link in results to your child edit page
 *
 * example: static $dokreGlobalSearchParent = ["parent_model"=>"Gallery", 'child_parent_id'=>"gallery_images_parent_id"];
